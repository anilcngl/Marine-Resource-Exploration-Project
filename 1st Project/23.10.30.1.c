...
void fillPolygon(SDL_Renderer *renderer, int *coordinates, int numPoints, int scaleFactor) {
    ...
    // Koordinatları geçerken çokgenin sınırlarını belirliyorum
    ...
    // Renk kullanarak çokgenin içini dolduruyorum
    SDL_SetRenderDrawColor(renderer, 255, 255, 255, 50);

    // Çokgenin içini doldurmak için dikdörtgenleri çiziyorum
